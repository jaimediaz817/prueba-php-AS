...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-04-2019 a las 20:15:41
...
(3, 2, 'anillo matrimonial', '2019-04-06 00:00:00', 18),
...
(40, 2, 2, '2019-04-06 00:00:00', 'remove');
...
--
ALTER TABLE `inventory_movements`
  MODIFY `movi_id_pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
